...
const copy = {
  de: {
    nav:{discover:"DISCOVER",domina:"FÜR DOMINAS",sub:"FÜR SUBS",how:"SO FUNKTIONIERT'S",pay:"ZAHLUNGEN",login:"LOGIN"},
  ...
  en: {
    nav:{discover:"DISCOVER",domina:"FOR DOMMES",sub:"FOR SUBS",how:"HOW IT WORKS",pay:"PAYMENTS",login:"LOGIN"},
    enter:"Enter House",
    ...
    intro:{kicker:"HOUSE OF DOMS",title:"More than a profile. A complete digital House.",lead:"House of Doms connects Dommes and subs in one platform: discover, connect, organise, book, communicate and pay – with clear roles, private areas and transparent workflows."},
    why:[["Discover Dommes","Browse public profiles, offers and availability and find the right Domme through Discover."],["Everything in one place","Messages, tasks, calendars, sessions, memberships, payments and House management in one system."],["Private & structured","Public presentation on the outside, protected spaces and clear workflows after login."]],
