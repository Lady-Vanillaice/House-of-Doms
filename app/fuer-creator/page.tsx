...
export default function CreatorInfoPage(){return <main className="infoPage">
  ...
  <section className="infoSection"><span className="infoKicker">TRANSPARENTE GEBÜHREN</span><h2>Du weißt vorher genau, was bei einem Verkauf anfällt.</h2><div className="feeBox"><h3>Klare Konditionen für dein Angebot.</h3><p>Wenn du über House of Doms Content, Memberships, digitale Angebote, Sessions oder Workshops verkaufst, findest du alle Gebühren, Prozentsätze und Zahlungsanbieter-Kosten transparent an einem Ort. So kannst du deine Preise und Einnahmen von Anfang an sauber planen.</p><div className="infoActions"><Link className="infoButton primary" href="/gebuehrenmodell">GEBÜHRENMODELL ANSEHEN</Link></div></div></section>
</main>}