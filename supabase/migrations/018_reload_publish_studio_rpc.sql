-- Repariert/registriert die RPC fuer Studio-Zeitfenster erneut und laedt den PostgREST-Schema-Cache neu.
...
-- PostgREST/Supabase API explizit anweisen, neue/veraenderte Funktionen neu einzulesen.
notify pgrst, 'reload schema';

-- Optionaler Selbsttest im SQL Editor: zeigt die registrierte Signatur.
select
...
where n.nspname = 'public'
  and p.proname = 'publish_studio_window';
